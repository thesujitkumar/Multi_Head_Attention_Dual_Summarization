...
from MADS_Models import CDS, MANS, MAT, MAS, MADS_BILSTM
...
def main():
    ...
    if args.model_name == 'MADS_BILSTM':
	    model = MADS_BILSTM.SimilarityTreeLSTM(
        vocab.size(),
        args.input_dim,
        args.mem_dim,
        args.hidden_dim,
        ...
        args.num_filter,
        args.number_head)
    elif args.model_name == 'CDS':
        model = CDS.SimilarityTreeLSTM(
        vocab.size(),
        args.input_dim,
        args.mem_dim,
        args.hidden_dim,
        ...
        args.num_filter,
        args.number_head)
    elif args.model_name == 'MANS':
        model = MANS.SimilarityTreeLSTM(
        vocab.size(),
        args.input_dim,
        args.mem_dim,
        args.hidden_dim,
    ...
    elif args.model_name == 'MAS':
        model = MAS.SimilarityTreeLSTM(
        vocab.size(),
        args.input_dim,
        args.mem_dim,
        args.hidden_dim,
